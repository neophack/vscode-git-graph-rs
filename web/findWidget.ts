...
class FindWidget {
	...
	constructor(view: GitGraphView) {
		...
		this.widgetElem.innerHTML = '<input id="findInput" type="text" placeholder="' + strings.findPlaceholder + '" disabled/><button type="button" id="findCaseSensitive" class="findModifier" title="' + strings.findMatchCase + '" aria-label="' + strings.findMatchCase + '">Aa</button><button type="button" id="findRegex" class="findModifier" title="' + strings.findUseRegex + '" aria-label="' + strings.findUseRegex + '">.*</button><span id="findPosition"></span><button type="button" id="findPrev" title="' + strings.findPrevMatch + '" aria-label="' + strings.findPrevMatch + '"></button><button type="button" id="findNext" title="' + strings.findNextMatch + '" aria-label="' + strings.findNextMatch + '"></button><button type="button" id="findOpenCdv" title="' + strings.findOpenCdv + '" aria-label="' + strings.findOpenCdv + '"></button><button type="button" id="findClose" title="' + strings.findClose + '" aria-label="' + strings.findClose + '"></button>';
