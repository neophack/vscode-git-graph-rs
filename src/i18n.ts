...
const EN = {
	...
	gerritChangeIdAmended: 'Amended the Change-Id {0} onto HEAD.',
	gerritChangeIdAlreadyPresent: 'HEAD already has the Change-Id {0}.',
...
const ZH_CN: Record<MessageKey, string> = {
	...
	gerritChangeIdAmended: '已将 Change-Id {0} 修补到 HEAD。',
	gerritChangeIdAlreadyPresent: 'HEAD 已经有 Change-Id {0}。',
